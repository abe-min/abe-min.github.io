...
function reportWin(rowNum,colNum) {
  console.log("You won connect four at this row,col");
  console.log(rowNum);
  console.log(colNum);
}
...
// Given a selected column, return the available unselected button that is still gray
function checkAvailable(colIndex) {
...
// Check if if 4 colors are matching
...
$('.game_board button').on('click',function() {

  // Recognize what column was chosen
  var col = $(this).closest("td").index();

  // Get back bottom available row to change
  var freeButton = checkAvailable(col);

  // Drop the chip in that column at the freeButton Row
  changeColor(freeButton,col,currentColor);
